<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<%= session.getAttribute("baseUrl") %>dashboard/user-home.jsp">Threadizzy</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="<%= session.getAttribute("baseUrl")+ "dashboard/panel/form-add-category-thread.jsp" %>"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Make Category Thread</a></li>
