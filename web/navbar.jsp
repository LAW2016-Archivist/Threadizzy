    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="<%out.print(session.getAttribute("baseUrl"));%>dashboard/panel/form-add-category-thread.jsp"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Make Category Thread</a></li>
