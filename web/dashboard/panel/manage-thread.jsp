                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4" style="margin-top: 4%">
                                <a class="btn btn-info"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> ADD POST</a>
                                <a class="btn btn-info"><span class="glyphicon glyphicon-erase" aria-hidden="true"></span> MANAGE POST</a><br>
                                <br>
                                <a class="btn btn-primary"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> EDIT</a>
                                <a class="btn btn-success"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> VIEW</a>
